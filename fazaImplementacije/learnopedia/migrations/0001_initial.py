    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isModerator', models.IntegerField(db_column='isModerator')),
                ('isAdministrator', models.IntegerField(db_column='isAdministrator')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdAt', models.DateTimeField(default=datetime.datetime(2022, 5, 18, 11, 5, 53, 708337))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField()),
                ('createdAt', models.DateTimeField(default=datetime.datetime(2022, 5, 18, 11, 5, 53, 709336))),
                ('articleId', models.ForeignKey(db_column='articleId', on_delete=django.db.models.deletion.DO_NOTHING, to='learnopedia.article')),
                ('korisnikId', models.ForeignKey(db_column='korisnikId', on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('korisnikId', models.OneToOneField(db_column='korisnikId', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('articleId', models.ForeignKey(db_column='articleId', on_delete=django.db.models.deletion.DO_NOTHING, to='learnopedia.article')),
            ],
            options={
